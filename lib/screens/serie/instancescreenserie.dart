...
class InstanceScreenSerie extends StatefulWidget {
  final Serie sintelContent1;

  const InstanceScreenSerie({Key key, this.sintelContent1}) : super(key: key);
  @override
  _InstanceScreenState createState() => _InstanceScreenState(sintelContent1);
}

class _InstanceScreenState extends State<InstanceScreenSerie> {
  final Serie sintelContent1;
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              Container(
                child: ContentHeaderSerie(featuredContent: sintelContent1),
              ),
              Container(
...
class _PlayButton extends StatelessWidget {
  ...
  final Serie ser;
  const _PlayButton({Key key, this.UrlVideo, this.ser}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return FlatButton.icon(
      ...
      onPressed: () async {
        ...
        if (Seriehistorique.contains(ser.name)) {
          Seriehistorique.remove(ser.name);
        }
        Seriehistorique.add(ser.name);

        perfs.setStringList('seriehistory', Seriehistorique);
        Navigator.push(
          context,
          MaterialPageRoute(
